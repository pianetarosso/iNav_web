...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Floor.descrizione'
        db.delete_column('buildings_floor', 'descrizione')


        # Changing field 'Floor.immagine'
        db.alter_column('buildings_floor', 'immagine', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100))

        # Changing field 'Building.foto'
        db.alter_column('buildings_building', 'foto', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100))

    def backwards(self, orm):
        # Adding field 'Floor.descrizione'
        db.add_column('buildings_floor', 'descrizione',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=1000, blank=True),
                      keep_default=False)


        # Changing field 'Floor.immagine'
        db.alter_column('buildings_floor', 'immagine', self.gf('django.db.models.fields.files.ImageField')(max_length=100))

        # Changing field 'Building.foto'
        db.alter_column('buildings_building', 'foto', self.gf('django.db.models.fields.files.ImageField')(max_length=100))
