...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Building.base_bearing'
        db.add_column('buildings_building', 'base_bearing',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Building.base_bearing'
        db.delete_column('buildings_building', 'base_bearing')
    ...
    models = {
        ...
        'buildings.building': {
            ...
            'base_bearing': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '6', 'decimal_places': '2'}),
