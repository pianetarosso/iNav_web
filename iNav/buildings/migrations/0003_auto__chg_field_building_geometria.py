...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Building.geometria'
        db.alter_column('buildings_building', 'geometria', self.gf('django.contrib.gis.db.models.fields.PolygonField')(null=True, geography=True))

    def backwards(self, orm):

        # Changing field 'Building.geometria'
        db.alter_column('buildings_building', 'geometria', self.gf('django.contrib.gis.db.models.fields.PolygonField')(null=True))
