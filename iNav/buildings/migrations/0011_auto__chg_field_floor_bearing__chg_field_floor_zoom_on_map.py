...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Floor.bearing'
        db.alter_column('buildings_floor', 'bearing', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=9, decimal_places=6))

        # Changing field 'Floor.zoom_on_map'
        db.alter_column('buildings_floor', 'zoom_on_map', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=3))

    def backwards(self, orm):

        # Changing field 'Floor.bearing'
        db.alter_column('buildings_floor', 'bearing', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=3))

        # Changing field 'Floor.zoom_on_map'
        db.alter_column('buildings_floor', 'zoom_on_map', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=3))
    ...
    models = {
        ...
        'buildings.building': {
            ...
            'base_bearing': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '9', 'decimal_places': '6', 'blank': 'True'}),
            'citta': ('django.db.models.fields.CharField', [], {'max_length': '30', 'blank': 'True'}),
            ...
            'foto': ('sorl.thumbnail.fields.ImageField', [], {'max_length': '100', 'blank': 'True'}),
            'geometria': ('django.contrib.gis.db.models.fields.PolygonField', [], {'blank': 'True', 'null': 'True', 'geography': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'link': ('django.db.models.fields.URLField', [], {'max_length': '200', 'blank': 'True'}),
            'nazione': ('django.db.models.fields.CharField', [], {'max_length': '30', 'blank': 'True'}),
            'nome': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '200'}),
            'posizione': ('django.contrib.gis.db.models.fields.PointField', [], {'unique': 'True', 'null': 'True', 'blank': 'True'}),
        ...
        'buildings.floor': {
            ...
            'bearing': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '9', 'decimal_places': '6'}),
            ...
            'zoom_of_map': ('django.db.models.fields.IntegerField', [], {'max_length': '2', 'null': 'True'}),
            'zoom_on_map': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '6', 'decimal_places': '3'})
        },
        'buildings.path': {
