...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Floor.bearing'
        db.alter_column('buildings_floor', 'bearing', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=2))
    ...
    models = {
        ...
        'buildings.floor': {
            ...
            'bearing': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '8', 'decimal_places': '3'}),
