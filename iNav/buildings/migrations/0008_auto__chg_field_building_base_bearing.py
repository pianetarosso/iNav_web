...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Building.base_bearing'
        db.alter_column('buildings_building', 'base_bearing', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=9, decimal_places=6))

    def backwards(self, orm):

        # Changing field 'Building.base_bearing'
        db.alter_column('buildings_building', 'base_bearing', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=2))
